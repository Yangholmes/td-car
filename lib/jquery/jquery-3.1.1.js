 ...
 * td-alert
 */
jQuery.tdAlert = function(message){
	if( $('.translucent-mask').length ){
		$('.translucent-mask').fadeIn();
		$('.message-box-frame').fadeIn().children('.message-box-msg').html(message.toString());
		return true;
	}
  ...
  $messageBoxMsg.html(message.toString()).css(messageBoxMsgStyle);
  ...
  .on('touchstart', function(e){
    $(e.currentTarget).css({
        'box-shadow': 'inset 0px 0px 3px 1px rgba(120, 120, 120, 0.5)',
  ...
  .on('touchend', function(e){
    ...
    .parent('.message-box-frame').fadeOut();
    $('.translucent-mask').fadeOut();
  });
