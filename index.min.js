...
type:"POST",data:a,dataType:"json",processData:!1,contentType:!1,cache:!1,success:function(a,b,c){0==a.error?(localStorage.setItem(a.records.resid,JSON.stringify(a.records)),window.location.href="page/approval.html?resid="+a.records.resid):alert("\u63d0\u4ea4\u5931\u8d25")},error:function(a,b,c){alert(b)}})});$(".transparent-mask").on("touchend",function(a){$(".popup").fadeOut(200);$("body").removeClass("fixed")})};
