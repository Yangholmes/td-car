...
break;case "2":dd.biz.util.openLink({url:"./page/car.html?userid="+_user.userid,onSuccess:function(a){},onFail:function(){}});break;case "3":dd.biz.util.openLink({url:"./page/car-add.html?userid="+_user.userid,onSuccess:function(a){},onFail:function(){}})}},onFail:function(a){}})});dd.error(function(a){console.log("\u9519\u8bef\u4fe1\u606f: "+JSON.stringify(a));alert("\u9519\u8bef\u4fe1\u606f: "+JSON.stringify(a))});
