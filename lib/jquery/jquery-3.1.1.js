...
jQuery.tdAlert = function(message){
  message = filter(message);
	if( $('.translucent-mask').length ){
		$('.translucent-mask').fadeIn(100);
		$('.message-box-frame').fadeIn(100).children('.message-box-msg').html(message.toString());
		return true;
	}
  ...
  .on('touchend', function(e){
    ...
    .parent('.message-box-frame').fadeOut(100);
    $('.translucent-mask').fadeOut(100);
  });
