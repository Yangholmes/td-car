...
onFail:function(a){console.log("\u5fae\u5e94\u7528\u514d\u767b\u6388\u6743\u7801, \u9519\u8bef: ",a)}});dd.ui.pullToRefresh.disable();dd.biz.navigation.setTitle({title:"\u901a\u5bfc\u7528\u8f66",onSuccess:function(a){console.log(a)},onFail:function(a){console.log(JSON.stringify(a))}});dd.biz.navigation.setMenu({items:[{id:"1",text:"\u6211\u7684\u5386\u53f2"},{id:"2",text:"\u8f66\u7684\u7ba1\u7406"},{id:"3",text:"\u6dfb\u52a0\u8f66\u8f86"}],onSuccess:function(a){switch(a.id){case "1":dd.biz.util.openLink({url:"http://www.gdrtc.org/car/page/personal-history.html",
onSuccess:function(a){},onFail:function(){}});break;case "2":dd.biz.util.openLink({url:"http://192.168.4.16/dingding/td-car/page/car.html",onSuccess:function(a){},onFail:function(){}});break;case "3":if("0"==_user.admin_level)return $.tdAlert("\u8fd9\u4e2a\u64cd\u4f5c\u9700\u8981\u7ba1\u7406\u5458\u6743\u9650"),!1;dd.biz.util.openLink({url:"http://www.gdrtc.org/car/page/car-add.html?userid="+_user.userid,onSuccess:function(a){},onFail:function(){}})}},onFail:function(a){$.tdAlert(a)}})});
dd.error(function(a){console.log("\u9519\u8bef\u4fe1\u606f: "+JSON.stringify(a));$.tdAlert("\u9519\u8bef\u4fe1\u606f: \u9489\u9489\u9a8c\u8bc1\u5931\u8d25\uff0c\u8bf7\u91cd\u8bd5")});
