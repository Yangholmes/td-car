...
$(document).height()-$("body").height()-50?!0:!1});$("main").on("touchstart",function(a){loadmoreEnable&&(loadmoreMoveEnable=!0,positionY=a.changedTouches[0].clientY,$("ul.reservation-list div.pull-up-tip p").html("\u677e\u5f00\u52a0\u8f7d"))});$("main").on("touchmove",function(a){loadmoreEnable&&loadmoreMoveEnable&&(deltaY=a.changedTouches[0].clientY-positionY,$("ul.reservation-list").css("transform","translateY("+deltaY+"px)"))});$("main").on("touchend",function(a){loadmoreEnable&&loadmoreMoveEnable&&
(deltaY=a.changedTouches[0].clientY-positionY,loadmore(deltaY))})},offset=1,loadmore=function(a){$("ul.reservation-list div.pull-up-tip p").html("\u52a0\u8f7d\u4e2d\u2026\u2026");loadmoreMoveEnable=loadmoreEnable=!1;positionY=deltaY=0;var b=setInterval(function(){0<a?a=0:0==a?clearInterval(b):a+=10;$("ul.reservation-list").css("transform","translateY("+a+"px)")},10);$.ajax({url:"../server/reservation/personal-history-retrieve.php",dataType:"json",type:"POST",data:{user:_user.userid,offset:5*offset},
cache:!1,success:function(a){renderReservationInfo(a.reservation);$("ul.reservation-list div.pull-up-tip p").html("\u4e0a\u62c9\u52a0\u8f7d\u66f4\u591a");a.reservation.length?offset++:$("ul.reservation-list div.pull-up-tip p").html("\u5168\u90e8\u52a0\u8f7d\u5b8c\u6bd5")},error:function(a){$("ul.reservation-list div.pull-up-tip p").html("\u52a0\u8f7d\u5931\u8d25\uff0c\u8bf7\u91cd\u8bd5")}})};
